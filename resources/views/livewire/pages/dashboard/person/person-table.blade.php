...
<div class="relative">
    <div class="mb-6">
        <input
            ...
            placeholder="Search by name cokk pepek..."
            class="block w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:ring-blue-500"
        />
    </div>
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                ...
                <th scope="col" class="px-6 py-3">
                    <x-column-item label="Type" columnName="user_type" :sortField="$sortField" :sortDirection="$sortDirection" />
                </th>
                <th scope="col" class="px-6 py-3">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4 flex">
                        @if ($person->status === 'Active')
                            <div class="bg-green-100 text-green-800 text-xs font-medi≈um me-2 px-2.5 py-0.5 rounded border border-green-800">Active</div>
                        @else
                        <div class="bg-red-100 text-red-800 text-xs font-medi≈um me-2 px-2.5 py-0.5 rounded border border-red-800">Expired</div>

                        @endif
                    </td>
                    {{-- <td class="px-6 py-4">{{ $person->begin_time }}</td>
                    <td class="px-6 py-4">{{ $person->end_time }}</td> --}}
                  ...
                  <div class="p-4 md:p-5">
                      <ol class="relative border-s border-gray-200 dark:border-gray-600 ms-3.5 mb-4 md:mb-5">
                          <li class="mb-10 ms-8">
                              ...
                              <h3 class="flex items-start mb-1 text-lg font-semibold text-gray-900 dark:text-white">Begin Time <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3">Active</span></h3>
                              <time class="block mb-3 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">24 May 2024 - 15:00 WIB</time>
                          ...
                          <li class="mb-10 ms-8">
                              ...
                              <h3 class="mb-1 text-lg font-semibold text-gray-900 dark:text-white">End TIme</h3>
                              <time class="block mb-3 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">16 May 2024 - 12:00 WIB</time>
