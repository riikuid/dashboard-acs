<div>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {!! __('Access Control &raquo; Create') !!}
        </h2>
    </x-slot>
    <div class="py-12">
                ...
                <form wire:submit="store" class="w-full">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            <x-label required="true" for="name">Identity</x-label>
                            <x-input name="form.name" id="name" type="name" placeholder="ex: John Doe"
                                required />
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <select wire:model="form.user_type" name="user_type"
                        ...
                        <div class="w-full px-3">
                            <div class="flex items-center space-x-4 w-full">
                                ...
                                <div class="flex-1">
                                    ...
                                    <input wire:model="form.begin_time" id="start" type="datetime-local"
                                        ...
                                        name="start_date" max="2037-12-31T23:59" value="" required />
                                </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <input wire:model="form.end_time" id="end" type="datetime-local"
                                        class="w-full border border-gray-300 rounded-sm shadow-sm focus:ring-purple-500 focus:border-purple-500 text-gray-700 text-sm px-3 py-2"
                                        name="end_date" max="2037-12-31T23:59" value="" />
                                </div>
                            </div>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3 text-right">
                            <button type="submit"
                                class=" shadow-lg shadow-purple-300 bg-purple-500 hover:bg-purple-600 text-white text-sm font-bold py-2 px-4 rounded-sm">
                                Save Person
                            </button>
                        </div>
                    </div>
